...
/* Function to make a polynomial given the degree and coefficients */
struct polynomial make_polynomial(size_t degree, int* coeffs) {
	struct polynomial temp;
	temp.degree = degree;
	temp.coeffs = (int*) safe_malloc(MAX_POLYNOMIAL_SIZE * sizeof(int));
