...
void polynomial_matrix_inverse_recurser(struct polynomial_split_matrix* const F, int* s_array, struct polynomial_split_matrix* const A, struct polynomial_split_matrix* const B)
{
